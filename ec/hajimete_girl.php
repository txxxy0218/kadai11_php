...
<body>
    ...
    <main class="mobile-first">
            ...
            <div class="mobile-section">
                <img src="img/hajimete_girl.jpg" alt="" class="item-page-img">
                <div class="item-info">
                    <div class="item-name">
                        <a href="hajimete_girl.php"><h2>はじめてのおうち性教育キット for girl</h2></a>
                        <h3>4,980円（税込）</h3>    
                    </div>
            ...
            <div class="mobile-section">
                ...
                <div class="review-wrapper">
                    <div class="review">
                        <img src="img/女1.png" alt="">
                        <p>レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！<br>3歳女児ママ</p>
                    </div>
                    <div class="review">
                        <p>レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！<br>3歳女児パパ</p>
                        <img src="img/男2.png" alt="">  
                    </div>
                    <div class="review">
                        <img src="img/女3.png" alt="">
                        <p>レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！レビューが入るよ！<br>3歳女児ママ</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="custom-wrapper">
                        ...
                        <div class="custom-item">
                            ...
                            <div class="radio-wrapper">
                                <input type="radio" class="radio" name="pattern" id="ribon" value="リボン">
                                <label for="ribon">リボン</label>

                                <input type="radio" class="radio" name="pattern" id="kuro-ba-" value="クローバー">
                                <label for="kuro-ba-">クローバー</label>

                                <input type="radio" class="radio" name="pattern" id="heart" value="ハート">
                                <label for="heart">ハート</label>
                        ...
                        <div class="custom-item">
                            <h4>お風呂フレンド</h4>
                            <div class="radio-wrapper">
                                <input type="radio" class="radio" name="friend" id="f-usagi" value="うさぎ">
                                <label for="f-usagi">うさぎ</label>
                        ...
                        <input type="hidden" name="item" value="はじめてのおうち性教育キット for girl">
