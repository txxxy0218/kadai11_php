...
<body>
    ...
    <main class="mobile-first">
            ...
            <div class="mobile-section">
                <img src="img/toitore_boy.jpg" alt="" class="item-page-img">
                <div class="item-info">
                    <div class="item-name">
                        <a href="toitore_boy.php"><h2>はじめてのトイトレちゃれんじキット for boy</h2></a>
                        <h3>4,980円（税込）</h3>    
                    </div>
            ...
            <div class="mobile-section" id="custom">
                ...
                <form action="cart.php" method="post" class="custom-item">
                    <div class="custom-wrapper">
                        ...
                        <input type="hidden" name="item" value="はじめてのトイトレちゃれんじキット for boy">
